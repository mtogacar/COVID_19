...
%imge alma
outputFolder = fullfile('D:/OrtakCalismalar/Mesut/COVID/dataset/','original'); % define output folder
...
trainingFeatures = activations(netTransfer, trainingSet, 'pool10', ...
    'MiniBatchSize', 64, 'OutputAs', 'columns');
...
testFeatures = activations(netTransfer, testSet, 'pool10', ...
    'MiniBatchSize', 64, 'OutputAs', 'columns');
